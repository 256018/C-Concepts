...
int func1(int b1)
{
    //static int myvar = ret(); Not allowed as only constant literal are only allowed.
    static int myvar=98;
...
int main()
{
    ...
    int val = func1(b); // myvar retain its previous value which is 98 and then increment it to 99.
    val = func1(b);
    val = func1(b);
    val = func1(b);
    val = func1(b);
